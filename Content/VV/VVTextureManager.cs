    ...
    public class VVTextureManager : ModSystem
    {
        ...
        public override void Load()
        {
            if (!Main.dedServ)
            {
                ...
                EquipLoader.AddEquipTexture(Mod, "ShardionsMod/Assets/VV/Items/Vanity/Sophisticated/SophisticatedStockings_FemaleLegs", EquipType.Legs, null, "SophisticatedStockings_FemaleLegs");
