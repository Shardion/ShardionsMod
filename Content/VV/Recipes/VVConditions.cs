...
namespace ShardionsMod.Content.VV.Recipes
{
    public class VVConditions : ModSystem
    {
        ...
        public static readonly Condition IsPreBossFamiliarSetEnabled = new Condition(NetworkText.FromKey("RecipeConditions.IsPreBossFamiliarSetEnabled"), _ => ModContent.GetInstance<Utilities.VariousVanitiesConfig>().PreBossFamiliarSet && ModContent.GetInstance<Utilities.VariousVanitiesConfig>().VariousVanitiesEnabled);
    }
}